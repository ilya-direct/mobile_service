...
class PhpManager extends BaseManager
{
    ...
    {
        throw new InvalidCallException("Cannot assign");
    }
    ...
    {
        throw new InvalidCallException("Cannot revoke");
    }
    ...
    {
        throw new InvalidCallException("Cannot revoke all");
    }
    ...
    {
        throw new InvalidCallException("Cannot remove all assignments");
    }
    ...
    {
        throw new InvalidCallException("Cannot save assignments");
    }
